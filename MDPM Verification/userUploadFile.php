...
<div id="particles-js" style="position: absolute;z-index: 0">
    <div style="position: absolute;z-index: 1;margin-top: 20px;width: 100%;text-align: center">
        ...
        */
        ...
        ?>
        <div class="taCenter" >
            <h1 style="font-size: 15pt;margin-top: 3%">The Data Name Encryption System</h1>
            <?php
            if(!empty($dn) && !empty($dir)){
            ...
            ?>
            <span style="font-size: 11pt;">Input the Data encryption attribute：</span><input type="text" name="att" value="<?=$att?>"> <span style="font-size: 11pt;">(e.g:minister or master or member)</span><br />
		...
		</select--><span style="font-size: 11pt;">The folder that you will upload to：</span><input type="text" name="dirName" value="<?=$dn?>" readonly /><input type="hidden" name="dstFolder" value="<?=$dir?>" readonly /><br />
            <div name="inFolder"<?php if($dstFolder!='0'){echo ' style="display:none;"';} ?> style="font-size: 11pt">Input the new folder name:<input type="text" name="folder" /><br /></div>
            <span style="font-size: 11pt;">Choose Datas：</span><input type="file" name="myfile"><br />
            <span style="font-size: 11pt;">Input the Indexword about uploaded file：</span><input type="text" name="keywords" value="<?=$keywords?>">&nbsp;<span style="font-size: 11pt;">(Indexword separated by space )</span><br />
            <span style="font-size: 11pt;">Click the "KeyGen" button to generate the encryption key：</span><input type="button" name="KeyGen" value="KeyGen" onClick='javascript:keygen();' style="width: 80px;height: 30px;font-size: 12pt"><br /><input type="submit" value="start upload file" style="width: 150px;height: 30px;font-size: 12pt">
            </form>
        </div>
        <?php
        if(!empty($dn) && !empty($dir)){
            echo '<p class="rtFM" style="width: 200px;height: 30px;font-size: 12pt;"><a href="fm.php?action=show&dn='.$dn.'&dir='.$dir.'">click to return</a></p>';
        }else{
            echo '<p class="rtFM" style=""><a href="fm.php">click to return</a></p>';
        }
        ?>
        <div class="taCenter">
            <?php
            if($action=='upload'){
                ...
                */
                if(empty($keywords)){
                    echo '<p class="alarm"><b>Please input the Indexword.</b></p>';exit;
                }
                $root=$_SERVER['DOCUMENT_ROOT'];
                $upDir='files';
                $lstDir='lstFiles';
