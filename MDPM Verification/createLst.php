...
<div class="taCenter">
	<h1 style="font-size: 15pt;margin-top: 2%">Create a new Block</h1>
	<?php
	...
	?>
	<div style="text-align: left;margin-top: 1%;margin-left: 26.3%;font-size: 13pt">Input the file encryption attribute:<input type="text" name="att" value="<?=$att?>"> (e.g:minister or master or member)<br /></div>
	<div style="text-align: left;margin-top: 1%;margin-left: 30%;font-size: 13pt">Input the new block name:<input type="text" name="folder" value="<?=$folder?>">&nbsp;&nbsp;<input type="submit" value="ok, create it." style="font-size: 13pt"/><br /></div><br />
		<input type="hidden" name="dst" value="<?=$dir?>" readonly />
	</form>
</div>
<?php
	if($dir=='root'){
		echo '<p class="rtFM" style="margin-top: 0!important; width: 200px;height: 30px;font-size: 12pt;margin-right: auto;margin-left: auto"><a href="fm.php?action=show">click to return</a></p>';
	}else{
		echo '<p class="rtFM" style="margin-top: 0!important;width: 200px;height: 30px;font-size: 12pt;margin-right: auto;margin-left: auto"><a href="fm.php?action=show&dn='.$dn.'&dir='.$dir.'">click to return</a></p>';
	}
?>
